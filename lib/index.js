...
var DeplyTool = (function (_super) {
    ...
    DeplyTool.prototype.patterns = function () {
    ...
    DeplyTool.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var sftp, localRoot_1, serverRoot_1, files_1, _i, _a, p, _files, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        files_1 = [];
                        for (_i = 0, _a = this.patterns(); _i < _a.length; _i++) {
                            p = _a[_i];
                            _files = glob.sync(p, {
                                cwd: localRoot_1
                            })
            ...
            return new Promise(function (resolve, reject) {
                ...
                conn.on('ready', function () {
                    conn
                        ...
                        stream.on('error', function (err) { return setTimeout(function () { return reject(err); }, 500); });
                        _this.emit(exports.EVENTS.CmdStart, cmd, 'remote', stream);
                        stream.end(cmd + '\nexit\n');
                    });
                })
                    .connect({
